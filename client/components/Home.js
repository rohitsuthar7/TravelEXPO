...
const Home = () => {
  ...
  return (
    ...
    <div id='custom-text-container' className='container-fluid'>
        <div className='row justify-content-center'>
            <div className='col-sm-10 bg-light box-shadow p-3 p-md-4 border rounded-1'>
    ...
    <div className='container-fluid half-color-background pt-1 pb-2'>
        <div style={{alignItems:"stretch"}} className='row justify-content-center mt-3'>
            <div className='card col-10 col-md-3 m-3 p-0 box-shadow border' onClick={()=>navigate('/social')}>
            ...
            <div className='card col-10 col-md-3 m-3 p-0 box-shadow border' onClick={()=>navigate('/blogs')}>
                <img className="card-img-top custom-card-image"
                 src={bloggingImg}
                 alt="Card cap"/>
                <div className="card-body">
